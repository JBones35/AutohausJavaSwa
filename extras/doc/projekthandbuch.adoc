...
== Der Microservice Autohaus

=== Der Microservice im Überblick

bla bla

.Use Cases für den Microservice "Autohaus"
...
.Komponenten des Microservice "Autohaus"
...
."AutohausGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,AutohausGetController,svg]
----
include::./AutohausGetController.plantuml[]
----

.Die Klasse "AutohausModel" für den Datenaustausch bei GET
[plantuml,AutohausModel,svg]
----
include::./AutohausModel.plantuml[]
----
...
."AutohausWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,AutohausWriteController,svg]
----
include::./AutohausWriteController.plantuml[]
----
...
.Die Service-Klasse "AutohausReadService" für die Geschäftslogik
[plantuml,AutohausReadService,svg]
----
include::./AutohausReadService.plantuml[]
----

bla bla

.Die Service-Klasse "AutohausWriteService" für die Geschäftslogik
[plantuml,AutohausWriteService,svg]
----
include::./AutohausWriteService.plantuml[]
----
...
.Die Entity-Klasse "Autohaus" für Autohausndaten
[plantuml,Autohaus,svg]
----
include::./Autohaus.plantuml[]
----
