...
| livenessProbe.initialDelay | int | `0` | Anzahl Seautohausn, bis die Probe für Liveness abgesetzt wird |
| livenessProbe.period | int | `10` | periodischer Abstand zwischen den Liveness-Proben in Seautohausn |
| livenessProbe.timeout | int | `1` | Timeout für Liveness-Probe in Seautohausn |
...
| progressDeadlineSeconds | int | `10` | max. Wartezeit in Seautohausn, bis "failed progressing" eintritt |
| readinessProbe.failureThreshold | int | `3` | Max. Anzahl an Fehlversuchen bei den Readiness-Proben |
| readinessProbe.initialDelay | int | `0` | Anzahl Seautohausn, bis die Probe für Readiness abgesetzt wird |
| readinessProbe.period | int | `10` | periodischer Abstand zwischen den Readiness-Proben in Seautohausn |
| readinessProbe.timeout | int | `1` | Timeout für Readiness-Probe in Seautohausn |
