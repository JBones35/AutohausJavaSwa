...
/// Hilfsklasse um URIs für _HATEOAS_ oder für URIs in  zu ermitteln, falls ein _API-Gateway_ verwendet
/// wird.
///
...
class UriHelper {
    ...
    private static final String AUTOHAUS_PREFIX = "/autohaus";
    ...
    private URI getBaseUriForwarded(final HttpServletRequest request, final String forwardedHost) {
        ...
        if (forwardedPrefix == null) {
            ...
            forwardedPrefix = AUTOHAUS_PREFIX;
        }
