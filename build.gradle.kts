...
plugins {
    ...
    // Plugins muessen statisch definiert sein https://docs.gradle.org/current/userguide/plugins.html#plugins_dsl_limitations
...
repositories {
    ...
    if (libs.versions.springdoc.openapi.get().endsWith("-SNAPSHOT")) {
...
tasks.named("bootBuildImage", org.springframework.boot.gradle.tasks.bundling.BootBuildImage::class.java) {
    ...
    environment =
        mapOf(
            ...
            "BP_JVM_VERSION" to javaLanguageVersionBuildpacks, // default: 17
...
sonarqube {
    properties {
        ...
        property("sonar.projectVersion", "2024.10.1")
